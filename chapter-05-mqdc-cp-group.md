# CHAPTER 5: MQDC / CP GROUP

---

**REAL FACTS:**

Company: MQDC, CP Group Family Office
Dates: December 2012 – June 2016
Titles: General Manager (2012–2013) / VP Business Intelligence / Chief of Staff / Innovation Strategy Lead (2013–2016)
Note: Chearavanont family office — Forbes #1 wealthiest family SEA. Avg deal size $500M. Personally thanked by Dhanin Chearavanont (CP Group principal)
...
→ Originated True Digital Park concept — JV MQDC/True: USD$568M, 10,000 sqm. Launched 2018 — Thailand's first major tech ecosystem hub

→ Whizdom101 w/ Virgin Group — USD$1.5B mixed-use development. Lease 50%+, Sold 80%+

→ Led UBS to launch DT Family Foundation — impact-first trust HK. Supports 400+ schools + social enterprises globally. CEO recognized Forbes Asia Philanthropist

→ Aging hub Shanghai: $162M, 246-beds — feasibility with Fortress Investment

→ Hampton Creek co-investment analysis (Bill Gates + Li Ka Shing backed alternative protein)

→ Led JV: CP Group Sky Urban Solution Singapore

→ Silicon Valley immersion tours for principals: Google, Facebook, Uber, Airbnb (Brian Chesky came), Gates Foundation, 500 Startups, Beyond Meat, Instacart, Khosla

→ Assembled advisory dream team (all pro bono): 500 Startups, Plug & Play, regional VCs, Singapore ICT co-founder of Match.com — everyone worked free because the vision was that compelling

→ Promoted GM → VP without asking. Fought over internally by 2 divisions. Offered to run True Digital Park full-time — declined for green card
